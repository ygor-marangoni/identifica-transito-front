...
useHead({ title: 'Veículos - Admin | Identifica Trânsito' });
...
const fetchVehicleStats = async () => {
    ...
    try {
        const res = await $api('/admin-pdv/vehicles/totals') as any;
...
const fetchVehicles = async (page = 1) => {
    ...
    try {
        ...
        const res = await $api(`/admin-pdv/vehicles?${params}`) as any;
...
const handleDelete = (vehicle: Vehicle) => {
    confirm.require({
        ...
        accept: async () => {
            try {
                await $api(`/admin-pdv/vehicles/${vehicle.id}`, { method: 'DELETE' });
    ...
    <div class="space-y-6">
        ...
        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
            ...
            <div class="flex flex-wrap items-center gap-3 mb-6">
                ...
                <span class="text-sm text-gray-500 ml-auto">{{ pagination.total }} veículo(s)</span>
            </div>
                ...
                <table class="w-full text-sm">
                    <thead>
                        <tr class="border-b-2 border-gray-200 bg-gray-50">
                            ...
                            <th class="text-left py-3 px-4 text-gray-700 font-semibold">Automóvel</th>
                            <th class="text-left py-3 px-4 text-gray-700 font-semibold">Tipo</th>
                            <th class="text-left py-3 px-4 text-gray-700 font-semibold">Perfil do Motorista</th>
                            <th class="text-left py-3 px-4 text-gray-700 font-semibold">Registro</th>
                    ...
                    <tbody>
                        ...
                        >
                            ...
                            <td class="py-3 px-4 text-gray-700">{{ v.user_name || '-' }}</td>
                            <td class="py-3 px-4">
