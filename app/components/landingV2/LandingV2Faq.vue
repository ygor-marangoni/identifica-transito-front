...
onMounted(async () => {
    ...
    animation = gsap.timeline({
        ...
        .from(introParts, { y: 20, autoAlpha: 0, duration: 1.0, stagger: .1, ease: 'power2.out' })
        .from(actions, { y: 14, autoAlpha: 0, duration: .8, stagger: .09, ease: 'power2.out' }, '-=.48')
