...
.v2-faq__list { min-width:0; }.v2-faq__item { margin-bottom:12px; border:1px solid #d8e0ec; border-radius:18px; background:rgba(255,255,255,.72); transition:border-color .25s ease,background .25s ease; }.v2-faq__item.is-open { border-color:#b7caf0; background:linear-gradient(110deg,#fff,#f7faff); }
...
@media (max-width:850px) { .v2-faq { padding-top:78px; padding-bottom:88px; }.v2-faq h2 { font-size:32px; }.v2-faq__grid { display:block; }.v2-faq__intro { max-width:none; }.v2-faq__list { margin-top:42px; } }
@media (max-width:560px) { .v2-faq { padding:62px 20px 72px; }.v2-faq h2 { font-size:30px; }.v2-faq__description { margin-top:18px; font-size:16px; }.v2-faq__actions { margin-top:28px; }.v2-faq__action { min-height:78px; padding:13px 14px; }.v2-faq__action-icon { width:42px; height:42px; border-radius:12px; }.v2-faq__action strong { font-size:14px; }.v2-faq__action small { font-size:12px; }.v2-faq__list { margin-top:38px; }.v2-faq__item { margin-bottom:10px; border-radius:15px; }.v2-faq__trigger { gap:12px; padding:15px 16px; font-size:.94rem; }.v2-faq__question { gap:10px; }.v2-faq__question i { width:38px; height:38px; border-radius:12px; }.v2-faq__answer p { padding-right:18px; padding-left:64px; font-size:.87rem; }.v2-faq__item.is-open .v2-faq__answer p { padding-bottom:21px; } }
