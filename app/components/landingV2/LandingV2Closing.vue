        ...
        <section class="v2-closing__cta" aria-labelledby="v2-closing-title">
            ...
            <div class="v2-closing__cta-inner">
                ...
                <aside class="v2-closing__visual">
                    <img src="/landing-v2/images/closing/imagem-beneficio.webp" alt="Etiqueta Identifica Trânsito e plataforma digital" width="760" height="560" loading="lazy">
                    <span>Etiquetas refletivas com QR Code</span>
                </aside>
            </div>
        </section>
